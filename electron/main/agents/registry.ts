...
const builtinAgents: AgentDefinition[] = [
  ...
  },
  {
    ...
    systemPrompt: [
      ...
      '- If all checks for THIS iteration pass: state clearly that the review is approved. Do NOT mention @developer.',
      '- If any check for THIS iteration fails: describe the issues and end your comment with `@developer fix the following issues: ...`',
