...
- [x] `.anima/toolchain.toml` generation from detection results
- [x] VISION.md templates for common project types (web-app, cli-tool, library)
- [x] `anima init` command wiring + module implementation
- [x] `anima approve` command wiring + module implementation (requires v0.6 gate)
- [x] Rich terminal output: progress bars, colored status, iteration summaries
- [x] Published to PyPI, installable via `uv tool install anima`
