...
- [ ] Tests for gap_analyzer validating SPEC.md
- [ ] Wire analyze_gaps into wiring.py with conformance test
- [ ] Implement modules/planner/core.py with structured IterationPlan
- [ ] Tests for planner validating SPEC.md
- [ ] Wire plan_iteration into wiring.py with conformance test
