...
- [x] Implement modules/gap_analyzer/core.py with structured GapReport
- [x] Tests for gap_analyzer validating SPEC.md (behavior)
- [x] Wire analyze_gaps into wiring.py with conformance test validating CONTRACT.md (interface)
- [x] Implement modules/planner/core.py with structured IterationPlan
- [x] Tests for planner validating SPEC.md (behavior)
- [x] Wire plan_iteration into wiring.py with conformance test validating CONTRACT.md (interface)
