...
- [x] Implement adapters/agents/claude_code.py (ClaudeCodeAdapter implements AgentPort)
- [x] Implement modules/executor/core.py with retry logic and structured output
- [x] Tests for executor validating SPEC.md (behavior, with mock AgentPort)
- [x] Wire execute_plan into wiring.py with conformance test validating CONTRACT.md (interface)
