...
<!-- anima:status:start -->
![status](https://img.shields.io/badge/status-alive-brightgreen) ![milestone](https://img.shields.io/badge/milestone-v0.5.0-purple) ![time](https://img.shields.io/badge/time-1h_38m-blue) ![tokens](https://img.shields.io/badge/tokens-31.8M-blue) ![cost](https://img.shields.io/badge/cost-%2427.39-blue)
<!-- anima:status:end -->
...
**Milestone: v0.5.0** — Roadmap: 33 / 58 tasks complete
<!-- anima:progress:end -->
