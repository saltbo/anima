...
<!-- anima:status:start -->
![status](https://img.shields.io/badge/status-alive-brightgreen) ![milestone](https://img.shields.io/badge/milestone-v0.2.0-purple) ![time](https://img.shields.io/badge/time-1h_9m-blue) ![tokens](https://img.shields.io/badge/tokens-21.6M-blue) ![cost](https://img.shields.io/badge/cost-%2419.11-blue)
<!-- anima:status:end -->
...
**Milestone: v0.2.0** — Roadmap: 18 / 58 tasks complete
<!-- anima:progress:end -->
