...
<!-- anima:status:start -->
![status](https://img.shields.io/badge/status-alive-brightgreen) ![milestone](https://img.shields.io/badge/milestone-v0.1.0-purple) ![time](https://img.shields.io/badge/time-40m-blue) ![tokens](https://img.shields.io/badge/tokens-11.1M-blue) ![cost](https://img.shields.io/badge/cost-%2410.48-blue)
<!-- anima:status:end -->
...
**Milestone: v0.1.0** — Roadmap: 8 / 58 tasks complete
<!-- anima:progress:end -->
