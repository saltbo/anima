...
<!-- anima:status:start -->
![status](https://img.shields.io/badge/status-alive-brightgreen) ![milestone](https://img.shields.io/badge/milestone-v0.6.0-purple) ![time](https://img.shields.io/badge/time-2h_52m-blue) ![tokens](https://img.shields.io/badge/tokens-47.0M-blue) ![cost](https://img.shields.io/badge/cost-%2441.46-blue)
<!-- anima:status:end -->
...
**Milestone: v0.6.0** — Roadmap: 43 / 58 tasks complete
<!-- anima:progress:end -->
