...
<!-- anima:status:start -->
![status](https://img.shields.io/badge/status-alive-brightgreen) ![milestone](https://img.shields.io/badge/milestone-v0.6.0-purple) ![time](https://img.shields.io/badge/time-2h_56m-blue) ![tokens](https://img.shields.io/badge/tokens-49.3M-blue) ![cost](https://img.shields.io/badge/cost-%2443.41-blue)
<!-- anima:status:end -->
...
**Milestone: v0.6.0** — Roadmap: 44 / 58 tasks complete
<!-- anima:progress:end -->
